...
(function () {
  ...
  var PLAT = (function () {
    try {
      if (navigator.vibrate) return 'android';
      var ua = navigator.userAgent || '';
      var iPadish = /iPad/.test(ua) || (/Macintosh/.test(ua) && navigator.maxTouchPoints > 1);
      return iPadish ? 'ipad' : 'iphone';
    } catch (e) { return 'iphone'; }
  })();
  var PNAME = { android: 'Android', ipad: 'iPad', iphone: 'iPhone' }[PLAT];
  ...
  function renderSetup() {
    ...
    brand.innerHTML = '<div class="logo">OVERRIDE</div><div class="tag">WAKE PROTOCOL // ' + APPV + '.2 - ' + PNAME + '</div>';
    r.appendChild(brand);
