...
(function () {
  ...
  function renderSetup() {
    ...
    brand.innerHTML = '<div class="logo">OVERRIDE</div><div class="tag">WAKE PROTOCOL // v8 - Android</div>';
    r.appendChild(brand);
    ...
    c4.innerHTML = '<h2>BEFORE YOU SLEEP - do these once (Samsung)</h2><ul class="check">' +
      ...
      '<li><span class="k">5.</span> <b>Plug it in</b>; <b>Power saving OFF</b>.</li>' +
  ...
  function renderArmed() {
    ...
    cd.innerHTML =
      ...
      '<div class="sub"><span class="warn">Keep this screen open &amp; the phone plugged in.</span><br>' +
