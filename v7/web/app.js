...
(function () {
  ...
  function renderSetup() {
    ...
    brand.innerHTML = '<div class="logo">OVERRIDE</div><div class="tag">WAKE PROTOCOL // v7.1 - iPad</div>';
    r.appendChild(brand);
    ...
    c4.innerHTML = '<h2>BEFORE YOU SLEEP - do these once</h2><ul class="check">' +
      '<li><span class="k">1.</span> <b>Add to Home Screen</b> (Share &gt; Add to Home Screen), then open it from the icon.</li>' +
      '<li><span class="k">2.</span> <b>Volume up</b> + iPad <b>not muted</b> (Control Center bell un-crossed).</li>' +
      ...
      '<li><span class="k">5.</span> Tap <b>ARM</b>, leave this open. Don&#39;t switch apps.</li>' +
    ...
    note.innerHTML = 'honest limit: a website can&#39;t lock iPad like a real app - it stays loud &amp; quiz-gated, but keep it open &amp; foreground.';
    r.appendChild(note);
  }
  ...
  function renderArmed() {
    ...
    cd.innerHTML =
      ...
      '<div class="sub"><span class="warn">Screen must stay ON (do not let it lock) &amp; the iPad plugged in.</span><br>' +
