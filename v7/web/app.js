...
(function () {
  ...
  function renderSetup() {
    ...
    brand.innerHTML = '<div class="logo">OVERRIDE</div><div class="tag">WAKE PROTOCOL // v7 - iPad</div>';
    r.appendChild(brand);
  ...
  function renderArmed() {
    ...
    cd.innerHTML =
      ...
      '<div class="sub"><span class="warn">Keep this screen open &amp; the iPad plugged in.</span><br>' +
